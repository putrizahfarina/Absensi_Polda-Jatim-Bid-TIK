...
$routes->group('admin', static function ($routes) {
    ...
    // Route untuk Import Excel/CSV Personel
    $routes->get('data-personel/import', 'Admin\DataPersonel::importView');
    $routes->post('data-personel/import', 'Admin\DataPersonel::import');

    // Route Trash & Restore Personel (SUDAH DIPERBAIKI)
    $routes->get('data-personel/trash', 'Admin\DataPersonel::trash');
    $routes->get('data-personel/restore/(:num)', 'Admin\DataPersonel::restore/$1');

    $routes->get('absensi', 'Admin\Absensi::index');

   // Rute untuk memproses data dari form absensi
    $routes->get('absensi', 'Admin\Absensi::index');
    $routes->post('absensi/simpan', 'Admin\Absensi::simpan');


    $routes->get('absensi', 'Admin\Absensi::index');
    $routes->post('absensi/simpan', 'Admin\Absensi::simpan');
    $routes->get('absensi/hapus/(:num)', 'Admin\Absensi::hapus/$1'); // <-- Rute hapus
